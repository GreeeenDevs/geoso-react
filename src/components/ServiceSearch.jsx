...
function ServiceSearch() {
  return (
    <section className="flex overflow-hidden flex-col px-20 py-20 w-full bg-white max-md:px-5 max-md:mr-1 max-md:max-w-full">
      <div className="max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col">
          ...
          <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/37a3388d0e870e67022f4402cd0d1c511617a81f10775a8763b982aca93f3bf9?placeholderIfAbsent=true&apiKey=50540d800e854c5199b8f44d34dba6f8"
      ...
      <button className="self-center px-9 py-4 mt-24 max-w-full text-lg font-medium tracking-tight text-center bg-emerald-500 rounded-md text-neutral-100 w-[362px] max-md:px-5 max-md:mt-10">
